...
export const en = {
	...
	workspace: {
		...
		instancesNeedGit: "Instances need a git repository",
		addProject: "Project",
	...
	git: {
		...
		tagTargetLabel: "Target",
		tagTargetHead: "Current commit (HEAD)",
		tagTargetCurrent: "current branch",
		tagTargetHint: "The tag is placed on the tip of the chosen branch.",
		...
		reset: "Reset",
		resetTitle: "Move the current branch",
		resetMoreActions: "More reset options",
		resetMode: {
			soft: "Reset (soft)",
			mixed: "Reset (mixed)",
			hard: "Reset (hard)",
		...
		resetModeHint: {
			soft: "Keeps the staged changes and the worktree",
			mixed: "Unstages the changes, keeps the worktree",
			hard: "Throws away the staged changes and the worktree",
		},
		resetConfirm: {
			soft: "The branch moves to this commit. The staged changes and the worktree are kept.",
			mixed:
				"The branch moves to this commit. The changes are unstaged but kept in the worktree.",
			hard: "The branch moves to this commit and every uncommitted change in the worktree is discarded. This cannot be undone.",
		},
		...
		commitMenu: {
			...
			"branch-from": "Create branch here",
			"tag-from": "Create tag here",
			"reset-soft": "Reset here (soft)",
			"reset-mixed": "Reset here (mixed)",
	...
	review: {
		...
		dismissed: "Dismissed",
		undismiss: "Reopen",
		remarkHandled: "Handled",
		remarkHandledTitle: "A comment has been written for this remark",
		comment: "Comment",
		draftComment: "Draft",
